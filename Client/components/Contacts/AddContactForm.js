    ...
    render() {
        ...
        return (
            <div className="card card-body">
                <div className="mb-2">        
                    <span className="h4 my-auto"><i className="fa fa-file-text-o fa-lg"></i> New Contact</span>
                ...
                <form onSubmit={this.onSave} className="mt-2">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" name="phone" onChange={this.onPhoneChange} />
                    </div>
